...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        case 3: // Detail of Course
            detailOfCourseMenu(mousePosition, touchPosition, indexMouse, cCourse, sStudent, menu, rec_detailOfCourseMenu, dummy, name, role, isChosen);
            break;
        ...
        case 22:
            ...
            break;
        case 26:
            lastSemesterNotFinish(mousePosition, touchPosition, indexMouse, menu, rec_back);
            break;
        case 27:
            lastYearNotFinish(mousePosition, touchPosition, indexMouse, menu, rec_back);;
            break;
        case 40:
